...
public class Model {
	...
	public static final double INTERVALL = 10;
	// player start coordinates
	public static final int PLX = 200;
	public static final int PLY = 100;
	// player extension
	public static final int PLW = 10;
	public static final int PLH = 20;
	...
	public Model() {
		...
		this.player = new Rectangle(PLX, PLY, PLW, PLH, 100, 0, 0, 0, physics, true);
