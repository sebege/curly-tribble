 ...
 * follows:
 * - Construct a Timer object with desired period
 * - Call reset() whenever periodic execution should (re-)start
 * - Call pause() once at each period, e.g.
 *   while (true) {
 *     // Do something, like moving an object
 *     timer.pause();
 *   }
 * 
 * @author rvh
